/// @file
/// @brief Functions for making HTTP requests.
...
namespace usos_rpc {
    ...
    /// @throws usos_rpc::Exception when the request or libcurl fails
    ...
    /// @return response data
    /// @throws usos_rpc::Exception when the underlying function calls fail
